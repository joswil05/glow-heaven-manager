    ...
    >
      {exito ? (
        <div className="flex flex-col items-center text-center py-4 gap-4 animate-m3-fade">
          <div className="flex h-16 w-16 items-center justify-center rounded-full bg-emerald-100 dark:bg-emerald-950/70 text-emerald-600 dark:text-emerald-400 shadow-sm">
            <CheckCircle2 size={36} />
          </div>

          <div>
            <h3 className="text-xl font-bold text-slate-900 dark:text-white">¡Abono registrado!</h3>
            <p className="text-sm text-slate-600 dark:text-slate-300 mt-1">
              Se recibieron <strong className="text-emerald-700 dark:text-emerald-400">{exito.montoFormateado}</strong> de {venta.cliente_nombre}.
            </p>
          ...
          <div className="flex flex-col w-full gap-2 mt-2">
            ...
            <button
              ...
              className="tocable flex w-full items-center justify-center rounded-2xl bg-slate-100 dark:bg-slate-800 px-4 py-3 text-sm font-semibold text-slate-700 dark:text-slate-200 active:scale-[0.98] transition-transform"
            >
              Listo
            </button>
          </div>
        ...
        <div className="flex flex-col gap-4 pb-6">
          ...
          <div className="flex items-center justify-between rounded-2xl bg-slate-50 dark:bg-slate-800/80 border border-slate-200/80 dark:border-slate-700/80 p-4">
            <div>
              <span className="text-xs font-medium text-slate-500 dark:text-slate-400">Saldo pendiente</span>
            ...
            <button
              ...
              className="m3-press rounded-xl bg-emerald-50 dark:bg-emerald-950/60 border border-emerald-200 dark:border-emerald-800/70 px-3 py-1.5 text-xs font-bold text-emerald-700 dark:text-emerald-400 hover:bg-emerald-100 dark:hover:bg-emerald-900/60"
            >
              Pagar todo
            </button>
          </div>
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="flex flex-col gap-1">
              <label className="text-xs font-semibold text-slate-600 dark:text-slate-300">Moneda del abono</label>
              <div className="flex rounded-xl bg-slate-100 dark:bg-slate-800/90 p-1">
                <button
                  type="button"
                  onClick={() => {
                    haptics.selection();
                  ...
                  className={`flex-1 py-1.5 text-xs font-bold rounded-lg transition-all ${
                    moneda === 'COR' ? 'bg-white dark:bg-slate-700 text-emerald-800 dark:text-emerald-300 shadow-sm' : 'text-slate-500 dark:text-slate-400'
                  }`}
                >
                  Córdobas (C$)
                </button>
                <button
                  ...
                  className={`flex-1 py-1.5 text-xs font-bold rounded-lg transition-all ${
                    moneda === 'USD' ? 'bg-white dark:bg-slate-700 text-emerald-800 dark:text-emerald-300 shadow-sm' : 'text-slate-500 dark:text-slate-400'
                  }`}
                >
                  Dólares (US$)
                </button>
            ...
            <div className="flex flex-col gap-1">
              <label className="text-xs font-semibold text-slate-600 dark:text-slate-300">Método de pago</label>
              <select
                value={metodo}
                onChange={(e) => setMetodo(e.target.value as MetodoPago)}
                className="w-full h-10 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 px-3 text-xs font-medium text-slate-800 dark:text-slate-100 outline-none focus:border-emerald-500"
              >
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="relative flex items-center">
              <span className="absolute left-3 text-slate-400 dark:text-slate-500 font-bold text-sm">
                {moneda === 'COR' ? 'C$' : '$'}
              </span>
              <input
                type="number"
                ...
                placeholder="0.00"
                className="w-full rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 pl-10 pr-4 py-2.5 text-base font-bold text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20"
              />
            </div>
          </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              className="w-full rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 px-3.5 py-2.5 text-xs text-slate-800 dark:text-slate-100 placeholder:text-slate-400 dark:placeholder:text-slate-500 outline-none focus:border-emerald-500"
            />
          </div>
