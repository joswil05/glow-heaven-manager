...
CREATE TABLE IF NOT EXISTS categorias (
    ...
    comision_defecto_bp INTEGER NOT NULL,
    arancel_estimado_bp INTEGER NOT NULL DEFAULT 3000,
    redondeo_cor_cents INTEGER NOT NULL DEFAULT 5000,
...
CREATE TABLE IF NOT EXISTS tiendas (
    ...
    nombre TEXT NOT NULL UNIQUE,
    url_base TEXT,
    tax_rate_bp INTEGER NOT NULL DEFAULT 700,
    activa INTEGER NOT NULL DEFAULT 1
);
...
CREATE TABLE IF NOT EXISTS clientes (
    ...
    direccion TEXT,
    ciudad TEXT NOT NULL DEFAULT 'León',
    cedula TEXT,
    notas TEXT,
    incumplio_anteriormente INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS cotizaciones (
    ...
    tarifa_flete_cents_lb INTEGER NOT NULL,
    ...
    anticipo_bp INTEGER NOT NULL DEFAULT 5000,
...
CREATE TABLE IF NOT EXISTS pagos (
    ...
    moneda_pago TEXT NOT NULL DEFAULT 'COR',
    tasa_cambio_cents INTEGER NOT NULL,
...
-- 13. Eventos y Auditoría (Deshacer por evento_grupo_id)
CREATE TABLE IF NOT EXISTS eventos (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    evento_grupo_id TEXT NOT NULL,
    entidad_tipo TEXT NOT NULL,
    entidad_id INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS cuentas_bancarias (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    banco TEXT NOT NULL,
    moneda TEXT NOT NULL DEFAULT 'COR',
